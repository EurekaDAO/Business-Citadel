...
import BusinessCitadelCore from "./BusinessCitadelCore.cdc"

pub contract EmployeBadgeVerifiers {
    ...
    pub struct Timelock: BusinessCitadelCore.IVerifier {
    ...
    pub struct Secret: BusinessCitadelCore.IVerifier {
    ...
    // delete their FLOATs.
    pub struct Limited: BusinessCitadelCore.IVerifier {
        pub var capacity: UInt64

        pub fun verify(_ params: {String: AnyStruct}) {
            let event = params["event"]! as! &BusinessCitadelCore.BusinessCitadel{BusinessCitadelCore.BusinessCitadelPublic}
    ...
    // from the list.
    pub struct MultipleSecret: BusinessCitadelCore.IVerifier {
